...
const calender = async () => {
  ...
  const url = 'https://airbnb13.p.rapidapi.com/calendar?room_id=18951965&currency=USD&year=2023&month=12&count=1';
const options = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': 'cbd6f82d8fmsh52b9f0475cc3716p19d79djsn4702f1ec7314',
...
const searchByGeoCoordinates = async () => {
  ...
  // optional: children, infants, pets, page, currency
  const url = 'https://airbnb13.p.rapidapi.com/search-geo?ne_lat=52.51&ne_lng=13.41&sw_lat=52.41&sw_lng=13.31&checkin=2023-09-15&checkout=2023-09-16&adults=1&children=0&infants=0&pets=0&page=1&currency=USD';
const options = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': 'cbd6f82d8fmsh52b9f0475cc3716p19d79djsn4702f1ec7314',
